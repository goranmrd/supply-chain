"""
Django settings for opply_project project.
...
SECRET_KEY = 'django-insecure-!j-^-bg4)y-3wm8=cfses#&^qgdi(l=#l%3geg-7%nlh04o-1#'
...
ROOT_URLCONF = 'opply_project.urls'
...
WSGI_APPLICATION = 'opply_project.wsgi.application'
